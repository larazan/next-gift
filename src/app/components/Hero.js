    ...
    <>
      <div className="bg-[#f2f6f6] flex relative z-20 items-center overflow-hidden">
        <div className="container2 mx-auto px-6 flex items-center relative py-12">
            <div className="sm:w-2/3 lg:w-2/5 px-6 flex flex-col relative z-20 text">
                
                <h1 className="font-bebas-neue uppercase text-3xl sm:text-5xl font-bold flex flex-col leading-none  text-[#b02768]">
                Life&apos;s a party.
                </h1>
                <h3 className='text-2xl font-semibold flex flex-col py-4 leading-tight tracking-tight  text-[#1d4943]'>
                Gift responsibly.
                </h3>
                <p className="text-sm sm:text-base text-gray-700  tracking-tight">
