      ...
      <div className="flex relative z-10 items-center overflow-hidden ">
        <div className="flex justify-between w-full py-6 md:py-10">
          ...
          <p className=" text-gray-900">
            At PLNTS.com, we love to try and discover new things. Especially if
            it has to do with new plants! At first, we thought this tryst was a
            failure, but after a bit more patience and growth, we saw the beauty
            of the plant. Wow, what a beauty right?!
          </p>
          <p className=" text-gray-900">
            She is a completely new Monstera species. Grown by PLNTS.com and
            PLNTS.com is also the only one allowed to grow the plant! So with
            this plant, you ABSOLUTELY get a unique and special plant in your
            home. This plant owes her name to our community, they came up with
            the name Frozen Freckles. If you look at her, you will of course
            understand why.
          </p>
          <p className=" text-gray-900">
            <strong>
            ...
            <Tab label="How To Use">
              <div className="py-4">
                <div className="w-1/2">
                    <h3 className="text-lg md:text-2xl capitalize font-semibold">usage</h3>
                  <p className="py-2 text-gray-700 text-md md:text-md">
                  For best anti-aging results, layer over Hyaluronic Sea Serum or Anti-Aging Sea Serum. On nights using Seaglow Overnight Serum, layer over for the perfect exfoliation + hydration night time routine.
                  </p>
                </div>
              </div>
            </Tab>
