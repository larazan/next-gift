            ...
            <div className="flex flex-1 flex-col items-center justify-center relative">
              <div className="flex flex-1 flex-col pb-18 max-w-md md:max-w-2xl ">
                <section className="w-full mx-auto  mt-2 md:mt-4 px-5 markdown-blog">
                  <article>
                    <p>
                    Welcome to your go-to resource for exceptional self-care gift basket ideas! Whether you’re planning a revitalizing DIY spa experience for yourself or looking to lavish a loved one with well-deserved indulgence, we’ve got something to suit every preference. Explore our handpicked guide to unearth the finest self-care gifts the market offers! 
                    </p>
                    <p>
