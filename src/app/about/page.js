...
import ava3 from "/public/assets/img/ava3.svg"
import ava4 from "/public/assets/img/ava4.svg"
      ...
      <div className="flex flex-col md:flex-row space-y-6 md:space-x-4 bg-white py-10 mx-auto w-11/12">
        ...
        <div className="w-full md:w-1/2 grid gap-4 grid-cols-2">
            <div className="flex flex-col space-y-3 bg-gray-100 rounded-lg p-5 shadow">
                ...
                <div className="text-lg font-semibold tracking-tight">Easy</div>
                <span className="text-sm leading-snug">Contrary to what you may believe, most of our courses are straightforward and easy to follow through. No jargons ever.</span>
            </div>
            <div className="flex flex-col space-y-3 bg-gray-100 rounded-lg p-5 shadow">
                <div>
                    <Image src={ava2} alt="" className="rounded-full w-16" />
                </div>
            ...
            <div className="flex flex-col space-y-3 bg-gray-100 rounded-lg p-5 shadow">
                <div>
                    <Image src={ava3} alt="" className="rounded-full w-16" />
                </div>
            ...
            <div className="flex flex-col space-y-3 bg-gray-100 rounded-lg p-5 shadow">
                <div>
                    <Image src={ava4} alt="" className="rounded-full w-16" />
                </div>
