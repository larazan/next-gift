              ...
              <div className="flex flex-1 flex-col justify-center md:space-y-5 px-4 max-w-md">
                ...
                <div className="flex flex-col max-w-md space-y-4 md:space-y-5">
                  ...
                  <div className="leading-tight">
                    <span className="text-xs font-gray-900 leading-tight">By signing up for our newsletter, you agree to receive email marketing messages from Credo Beauty. For more information, view our <Link href={"/"} className="underline underline-offset-1">Privacy Policy</Link> and <Link href={"/"} className="underline underline-offset-1">Terms of Service</Link></span>
                  </div>
                  {/* <Link
                  href={"/forgot"}
